...
{{
  ...
  "entity_type": "<primary entity name, e.g. users, orders, patients, transactions>",
  "columns": [
    {{
...
Rules:
- volume: extract explicit count ("50 users" → 50, "generate 1000" → 1000). null if not stated.
- columns: list ALL fields mentioned or strongly implied by the entity type. Use snake_case.
...
- compliance_rules: identify ALL sensitive fields and their applicable regulatory frameworks:
